...
// ValidateSession validates that the provided email exists in the configured Google
// group(s).
func (p *GoogleProvider) ValidateSession(s *SessionState) bool {
